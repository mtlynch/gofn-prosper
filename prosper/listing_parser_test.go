	...
	var tests = []struct {
		...
		},
		{
			input: thin.SearchResult{
				...
				DelinquenciesOver60Days:                   3,
				GroupIndicator:                            false,
				IncomeRange:                               85, // invalid income range
				ListingMonthlyPayment:                     285.46,
				OldestTradeOpenDate:                       "03221991",
				PriorProsperLoansPrincipalOutstanding:     0,
				PublicRecordsLast12Months:                 0,
			...
			expectSuccess: false,
			msg:           "listing with invalid income range should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
			...
			expectSuccess: false,
			msg:           "listing with invalid listing status should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				CurrentCreditLines:                        2,
				DtiWprosperLoan:                           0.14,
				FicoScore:                                 "invalid fico score", // invalid
				FirstRecordedCreditLine:                   "1991-03-22 08:00:00 +0000",
				RealEstateBalance:                         0,
				SatisfactoryAccounts:                      23,
				FundingThreshold:                          0.7,
			...
			expectSuccess: false,
			msg:           "listing with invalid FICO score should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
			...
			expectSuccess: false,
			msg:           "listing with invalid Prosper rating should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				IncomeRange:                               3,
				ListingMonthlyPayment:                     285.46,
				OldestTradeOpenDate:                       "-5555", // invalid
				PriorProsperLoansPrincipalOutstanding:     0,
				PublicRecordsLast12Months:                 0,
				TotalOpenRevolvingAccounts:                3,
				VerificationStage:                         2,
			...
			expectSuccess: false,
			msg:           "listing with invalid oldest trade open date should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				DtiWprosperLoan:                           0.14,
				FicoScore:                                 "660-679",
				FirstRecordedCreditLine:                   "invalid", // invalid
				RealEstateBalance:                         0,
				SatisfactoryAccounts:                      23,
				FundingThreshold:                          0.7,
				InquiriesLast6Months:                      3,
			...
			expectSuccess: false,
			msg:           "listing with invalid first recorded credit line should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				RealEstatePayment:                         0,
				CreditLinesLast7Years:                     28,
				CreditPullDate:                            "invalid", // invalid
				PublicRecordsLast10Years:                  0,
				RevolvingBalance:                          978,
				Scorex:                                    "702-723",
				ScorexChange:                              "",
			...
			expectSuccess: false,
			msg:           "listing with invalid credit pull date should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				EffectiveYield:                            0.1582,
				EstimatedLossRate:                         0.0824,
				ListingCreationDate:                       "invalid", // invalid
				Occupation:                                "",
				PercentFunded:                             0.1042,
				PriorProsperLoansBalanceOutstanding:       0,
				AmountRemaining:                           7166.09,
			...
			expectSuccess: false,
			msg:           "listing with invalid listing creation date should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				AmountRemaining:                           7166.09,
				DelinquenciesOver90Days:                   14,
				ListingEndDate:                            "invalid", // invalid
				OpenCreditLines:                           2,
				PriorProsperLoansActive:                   0,
				PriorProsperLoansLateCycles:               0,
				ListingTerm:                               36,
			...
			expectSuccess: false,
			msg:           "listing with invalid listing end date should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				DelinquenciesLast7Years:                   14,
				EmploymentStatusDescription:               "Other",
				ListingStartDate:                          "invalid", // invalid
				TotalTradeItems:                           28,
				BorrowerRate:                              0.1706,
				IsHomeowner:                               false,
				ListingAmount:                             8000,
			...
			expectSuccess: false,
			msg:           "listing with invalid listing start date should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				ProsperScore:                              4,
				RevolvingAvailablePercent:                 72,
				WholeLoanStartDate:                        "invalid", // invalid
				CurrentCreditLines:                        2,
				DtiWprosperLoan:                           0.14,
				FicoScore:                                 "660-679",
				FirstRecordedCreditLine:                   "1991-03-22 08:00:00 +0000",
			...
			expectSuccess: false,
			msg:           "listing with invalid whole oan start should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
				...
				BorrowerMetropolitanArea:                  "(Not Implemented)",
				MinPriorProsperLoan:                       0,
				WholeLoanEndDate:                          "invalid", // invalid
				AmountFunded:                              833.91,
				EffectiveYield:                            0.1582,
				EstimatedLossRate:                         0.0824,
				ListingCreationDate:                       "2015-12-04 00:31:34 +0000",
			...
			expectSuccess: false,
			msg:           "listing with invalid whole loan end should fail parsing",
		},
		{
			input: thin.SearchResult{
				PriorProsperLoans:                         0,
			...
			expectSuccess: false,
			msg:           "listing with invalid last updated date should fail parsing",
		},
	}
